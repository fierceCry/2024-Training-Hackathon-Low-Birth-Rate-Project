...
//     const regionMatches = recommendations.filter((rec) => rec && rec.isRegionMatch && rec.similarity >= similarityThreshold);
//     const otherRecommendations = recommendations.filter((rec) => rec && !rec.isRegionMatch && rec.similarity >= similarityThreshold);

//     // 유사도 기준으로 정렬
//     const sortedRegionMatches = regionMatches.sort((a, b) => b.similarity - a.similarity);
//     const sortedOtherRecommendations = otherRecommendations.sort((a, b) => b.similarity - a.similarity);
